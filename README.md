...
Container:
- Environment PAT for Github
- Mount Points for the Targets
- GH Cli should be used for all actions
...
- add an smpt functionality for notifiyin about critical issues or optional successfuly runs with a short summary
